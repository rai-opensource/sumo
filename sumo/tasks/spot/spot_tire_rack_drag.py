...
class SpotTireRackDrag(SpotBase):
    """Task getting Spot to drag a tire rack to the origin (goal location)."""

    name = "spot_tire_rack_drag"
    config_t = SpotTireRackDragConfig
    config: SpotTireRackDragConfig

    def __init__(self, config: SpotTireRackDragConfig | None = None) -> None:
        ...
        self.object_pose_idx = self.get_joint_position_start_index("tire_rack_joint")
        self.object_vel_idx = self.get_joint_velocity_start_index("tire_rack_joint")
        ...
        self.gripper_to_grasp_left_mid_idx = self.get_sensor_start_index("sensor_gripper_to_grasp_left_mid")
    ...
    def reward(
        ...
        gripper_to_grasp_left_mid = sensors[
            ..., self.gripper_to_grasp_left_mid_idx : self.gripper_to_grasp_left_mid_idx + 3
        ]
        ...
        rack_to_goal = np.array(self.config.goal_position)[None, None, :2] - object_pos[..., :2]
